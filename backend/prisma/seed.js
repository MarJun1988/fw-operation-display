...
const DEFAULT_SITE_STYLES = [
  ...
  },
  {
    ...
    htmlClass:
      'text-center content-center order-1 text-xl md:text-2xl font-bold',
    htmlStyle: '',
  },
  {
    ...
    htmlClass:
      'text-center content-center order-2 text-xl md:text-2xl font-bold',
    htmlStyle: '',
  },
  {
    ...
    htmlClass:
      'text-center content-center order-3 text-xl md:text-2xl font-bold',
    htmlStyle: '',
  },
  {
  ...
  },
  {
    ...
    htmlClass:
      'text-center text-1xl md:text-4xl font-bold text-red-700 m-3 mt-10',
    htmlStyle: '',
  },
  {
  ...
  // 3ter Abschnitt
  {
    ...
    htmlClass: 'w-90 h-90 fixed bottom-0',
    htmlStyle: '',
  },
  // 4ter Abschnitt
  {
