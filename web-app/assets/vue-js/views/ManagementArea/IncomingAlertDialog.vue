...
const closeDialog = () => {
  router.push({name: `${managementAreaNames.incomingAlerts}`})
};
...
// Store - eingegangenen Alarmierungen
...
// Überschrift
const headerTitle = ref(dialogs.value.incomingAlert.headerTitle);
...
const fields = ref({
  ...
  address: {
    ...
    cssClass: 'col-6',
    autofocus: true,
    label: dialogs.value.incomingAlert.fields.address.label,
    help: dialogs.value.incomingAlert.fields.address.help,
    maxlength: dialogs.value.incomingAlert.fields.address.maxlength,
    minlength: dialogs.value.incomingAlert.fields.address.minlength,
    required: dialogs.value.incomingAlert.fields.address.required
  },
  // Text - Alarmmeldung
  text: {
    fieldType: 'inputText',
    cssClass: 'col-6',
    autofocus: false,
    label: dialogs.value.incomingAlert.fields.text.label,
    help: dialogs.value.incomingAlert.fields.text.help,
    maxlength: dialogs.value.incomingAlert.fields.text.maxlength,
    minlength: dialogs.value.incomingAlert.fields.text.minlength,
    required: dialogs.value.incomingAlert.fields.text.required
  },
  // Kommentar
  comment: {
    fieldType: 'inputText',
    cssClass: 'col-12',
    autofocus: false,
    label: dialogs.value.incomingAlert.fields.comment.label,
    help: dialogs.value.incomingAlert.fields.comment.help,
    maxlength: dialogs.value.incomingAlert.fields.comment.maxlength,
    minlength: dialogs.value.incomingAlert.fields.comment.minlength,
    required: dialogs.value.incomingAlert.fields.comment.required
  }
});
...
// Name des Entity
const nameOfEntity = 'IncomingAlert';
...
const itemAction = async (type) => {
  ...
  if (await result.value.status === "success") {
    ...
    if (dialogAutoClose.value) {
      await router.push({name: `${managementAreaNames.incomingAlerts}`});
    }
    // await resetItem();
  } else {
