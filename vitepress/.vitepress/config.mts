...
import {grundlagenSidebar, vorWortSidebar} from "./sidebar/grundlagen";

// https://vitepress.dev/reference/site-config
export default defineConfig({
    title: "FW Operation Display",
    description: "Feuerwehr Display ist ein webbasiertes Einsatz- und Informationsdashboard für Feuerwehren.",
    base: '/help/',
    lang: 'de-DE',
    srcDir: './src',
    outDir: './dist',
