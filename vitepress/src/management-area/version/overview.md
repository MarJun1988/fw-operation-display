...
# &Uuml;bersicht Versionen

![&Uuml;bersicht der Versionen](/img/Version/060-Version-Overview.png)

In der &Uuml;bersicht der **Versionen** werden alle vorhandenen Eintr&auml;ge in Form einer &uuml;bersichtlichen Tabelle
dargestellt.

In der **Aktionsspalte** auf der rechten Seite kann jeder einzelne Eintrag eingesehen werden.  
Ein L&ouml;schen der Eintr&auml;ge ist nicht m&ouml;glich, da die Versionseintr&auml;ge f&uuml;r den fehlerfreien
Betrieb und die
Nachvollziehbarkeit der Anwendung notwendig sind.
...
- **Neuen Eintrag hinzuf&uuml;gen** (derzeit deaktiviert)
- **Mehrere Eintr&auml;ge l&ouml;schen** (ebenfalls deaktiviert)

Diese Funktionen sind bewusst deaktiviert, da die Versionshistorie automatisch von der Anwendung bzw. vom Entwickler
gepflegt wird.
...
Auf der **rechten Seite** steht eine **globale Suche** zur Verf&uuml;gung, mit der die gesamte Tabelle nach Inhalten
