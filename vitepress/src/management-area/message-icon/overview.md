...
# &Uuml;bersicht Mitteilungsicons

![&Uuml;bersicht der Mitteilungsicons](/img/Message-Icon/040-Message-Icon-Overview.png)

In der &Uuml;bersicht der **Mitteilungsicons** werden alle vorhandenen Eintr&auml;ge in Form einer &uuml;bersichtlichen
Tabelle
dargestellt.  
Diese Ansicht dient als zentrale Verwaltungs- und Informationsoberfl&auml;che f&uuml;r alle verf&uuml;gbaren
Mitteilungsicons.

In der **Aktionsspalte** auf der rechten Seite kann jeder einzelne Eintrag bearbeitet werden.  
Ein L&ouml;schen der Eintr&auml;ge ist m&ouml;glich und abh&auml;ngig von den jeweiligen Berechtigungen.
...
- **Mehrere Eintr&auml;ge l&ouml;schen**
