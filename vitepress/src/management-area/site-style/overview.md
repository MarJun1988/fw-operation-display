...
# &Uuml;bersicht Darstellung (CSS)

![&Uuml;bersicht der Darstellung (CSS)](/img/Site-Style/050-Site-Style-Overview.png)

In der &Uuml;bersicht der **Darstellungen (CSS)** werden alle vorhandenen Eintr&auml;ge in Form einer
&uuml;bersichtlichen Tabelle
dargestellt.  
Diese Ansicht dient als zentrale Verwaltungs- und Informationsoberfl&auml;che f&uuml;r alle Style- und Designanpassungen
der
Anwendung.
